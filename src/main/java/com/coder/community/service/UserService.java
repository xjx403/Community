...
public class UserService implements CommunityConstant {
    ...
    public Map<String,Object> register(User user){
        ...
        if(u!=null){
            ...
            logger.info("the message is put into map:"+map.get("usernameMsg"));
            return map;
        }
        ...
        if(u!=null){
            ...
            logger.info("the message is put into map:"+map.get("emailMsg"));
            return map;
        }

        //注册用户
        user.setSalt(CommunityUtil.generateUUD().substring(0,5));
        user.setPassword(CommunityUtil.md5(user.getPassword()+user.getSalt()));

        user.setType(0);
        user.setStatus(0);
        user.setActivationCode(CommunityUtil.generateUUD());
...
//        String content =templateEngine.process("mail/activation", context);
    ...
    public Map<String,Object> login(String username,String password,int expiredSeconds){
        ...
        loginTicket.setTicket(CommunityUtil.generateUUD());
